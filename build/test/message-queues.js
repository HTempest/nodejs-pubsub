...
class FakeClient {
    async acknowledge(reqOpts, callOptions) { }
    async modifyAckDeadline(reqOpts, callOptions) { }
}
...
mocha_1.describe('MessageQueues', () => {
    ...
    mocha_1.describe('MessageQueue', () => {
        ...
        mocha_1.describe('initialization', () => {
            mocha_1.it('should default numPendingRequests', () => {
                assert.strictEqual(messageQueue.numPendingRequests, 0);
            });
            mocha_1.it('should set any provided options', () => {
                const fakeOptions = {};
        ...
        mocha_1.describe('maxMilliseconds', () => {
            mocha_1.it('should return the maxMilliseconds option', () => {
        ...
        mocha_1.describe('flush', () => {
            mocha_1.it('should cancel scheduled flushes', () => {
                const clock = sandbox.useFakeTimers();
            ...
            mocha_1.it('should remove the messages from the queue', () => {
                messageQueue.add(new FakeMessage());
                messageQueue.flush();
                assert.strictEqual(messageQueue.numPendingRequests, 0);
            });
            mocha_1.it('should send the batch', () => {
            ...
            mocha_1.it('should emit any errors', done => {
            ...
            mocha_1.it('should resolve any pending promises', () => {
                const promise = messageQueue.onFlush();
                setImmediate(() => messageQueue.flush());
                return promise;
            });
        });
        mocha_1.describe('onFlush', () => {
            mocha_1.it('should create a promise', () => {
                const promise = messageQueue.onFlush();
                assert(promise instanceof Promise);
            });
            mocha_1.it('should re-use existing promises', () => {
        ...
        mocha_1.describe('setOptions', () => {
            mocha_1.it('should default maxMessages to 3000', () => {
                const stub = sandbox.stub(messageQueue, 'flush');
            ...
            mocha_1.it('should respect user supplied maxMessages', () => {
                const stub = sandbox.stub(messageQueue, 'flush');
            ...
            mocha_1.it('should default maxMilliseconds to 100', () => {
                const clock = sandbox.useFakeTimers();
                const stub = sandbox.stub(messageQueue, 'flush');
                messageQueue.add(new FakeMessage());
                clock.tick(100);
            ...
            mocha_1.it('should respect user supplied maxMilliseconds', () => {
                const clock = sandbox.useFakeTimers();
                const stub = sandbox.stub(messageQueue, 'flush');
    ...
    mocha_1.describe('AckQueue', () => {
        let ackQueue;
        beforeEach(() => {
            ackQueue = new AckQueue(subscriber);
        });
        mocha_1.it('should send batches via Client#acknowledge', async () => {
            const messages = [
                new FakeMessage(),
                new FakeMessage(),
                new FakeMessage(),
        ...
        mocha_1.it('should send call options', async () => {
        ...
        mocha_1.it('should throw a BatchError if unable to ack', done => {
            const messages = [
                new FakeMessage(),
                new FakeMessage(),
                new FakeMessage(),
    ...
    mocha_1.describe('ModAckQueue', () => {
        let modAckQueue;
        beforeEach(() => {
            modAckQueue = new ModAckQueue(subscriber);
        });
        mocha_1.it('should send batches via Client#modifyAckDeadline', async () => {
            const deadline = 600;
            const messages = [
                new FakeMessage(),
                new FakeMessage(),
        ...
        mocha_1.it('should group ackIds by deadline', async () => {
            const deadline1 = 600;
        ...
        mocha_1.it('should throw a BatchError if unable to modAck', done => {
            const messages = [
                new FakeMessage(),
                new FakeMessage(),
                new FakeMessage(),
