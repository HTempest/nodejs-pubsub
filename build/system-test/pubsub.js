...
mocha_1.describe('pubsub', () => {
    ...
    mocha_1.describe('Topic', () => {
        mocha_1.it('should be listed', async () => {
        ...
        mocha_1.it('should list topics in a stream', done => {
        ...
        mocha_1.it('should allow manual paging', async () => {
            const [topics] = await pubsub.getTopics({
        ...
        mocha_1.it('should be created and deleted', done => {
        ...
        mocha_1.it('should honor the autoCreate option', done => {
            const topic = pubsub.topic(generateTopicName());
            topic.get({ autoCreate: true }, done);
        });
        mocha_1.it('should confirm if a topic exists', done => {
        ...
        mocha_1.it('should confirm if a topic does not exist', done => {
        ...
        mocha_1.it('should publish a message', done => {
            const topic = pubsub.topic(TOPIC_NAMES[0]);
            const message = {
        ...
        mocha_1.it('should publish a message with attributes', async () => {
        ...
        mocha_1.it('should get the metadata of a topic', done => {
            const topic = pubsub.topic(TOPIC_NAMES[0]);
        ...
        mocha_1.describe('ordered messages', () => {
            mocha_1.it('should pass the acceptance tests', async () => {
                ...
                const { input, expected, } = require('../../system-test/fixtures/ordered-messages.json');
    ...
    mocha_1.describe('Subscription', () => {
        ...
        mocha_1.it('should return error if creating an existing subscription', done => {
        ...
        mocha_1.it('should list all subscriptions registered to the topic', done => {
        ...
        mocha_1.it('should list all topic subscriptions as a stream', done => {
        ...
        mocha_1.it('should list all subscriptions regardless of topic', done => {
        ...
        mocha_1.it('should list all subscriptions as a stream', done => {
        ...
        mocha_1.it('should allow creation and deletion of a subscription', done => {
        ...
        mocha_1.it('should confirm if a sub exists', done => {
        ...
        mocha_1.it('should confirm if a sub does not exist', done => {
        ...
        mocha_1.it('should create a subscription with message retention', done => {
            const subName = generateSubName();
        ...
        mocha_1.it('should set metadata for a subscription', () => {
            const subscription = topic.subscription(generateSubName());
            const threeDaysInSeconds = 3 * 24 * 60 * 60;
            return subscription
                .create()
        ...
        mocha_1.it('should error when using a non-existent subscription', done => {
            const subscription = topic.subscription(generateSubName());
        ...
        mocha_1.it('should receive the published messages', done => {
            let messageCount = 0;
        ...
        mocha_1.it('should ack the message', done => {
            const subscription = topic.subscription(SUB_NAMES[1]);
            subscription.on('error', done);
        ...
        mocha_1.it('should nack the message', done => {
            const subscription = topic.subscription(SUB_NAMES[1]);
            subscription.on('error', done);
        ...
        mocha_1.it('should respect flow control limits', done => {
            const maxMessages = 3;
            let messageCount = 0;
            const subscription = topic.subscription(SUB_NAMES[0], {
        ...
        mocha_1.it('should send and receive large messages', done => {
            const subscription = topic.subscription(SUB_NAMES[0]);
    ...
    mocha_1.describe('Snapshot', () => {
        ...
        mocha_1.it('should get a list of snapshots', done => {
        ...
        mocha_1.it('should get a list of snapshots as a stream', done => {
        ...
        mocha_1.describe('seeking', () => {
            ...
            mocha_1.it('should seek to a snapshot', done => {
                let messageCount = 0;
                subscription.on('error', done);
                subscription.on('message', message => {
                    if (message.id !== messageId) {
            ...
            mocha_1.it('should seek to a date', done => {
                let messageCount = 0;
                subscription.on('error', done);
                subscription.on('message', message => {
                    if (message.id !== messageId) {
